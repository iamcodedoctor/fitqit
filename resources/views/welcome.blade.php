            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        <h1 class='text-4xl text-gray-100 font-fold'>
                            FitQit
                        </h1>
                    </div>
                    @if (Route::has('login'))
                ...
                <main class='mt-6'>
                    <div class="p-4 max-w-md mx-auto">
                        <div class="bg-transparent border border-gray-100 text-white rounded-2xl shadow-lg p-6">
                            <h2 class="text-3xl font-bold mb-4">FitQit: Your Journey to a Healthier You</h2>

                            <div class="mb-4">
                                <span class="block text-xl">"Break the Chains of Addiction, Build the Body of Your Dreams."</span>
                            </div>

                            <div class="mb-4">
                                <span class="block text-xl">"Every Step Counts, Every Day Smoke-Free Is a Victory."</span>
                            </div>

                            <div class="mb-4">
                                <span class="block text-xl">"Push Harder, Get Stronger—Let FitQit Be Your Guide."</span>
                            </div>

                            <div class="mb-4">
                                <span class="block text-xl">"Stronger Mind, Stronger Body. FitQit is More Than Fitness."</span>
                            </div>
                        </div>
                    </div>
                </main>
